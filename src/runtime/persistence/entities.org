...
args = {"__tablename__": "lab",
    ...
    #    "experiments": db.relationship('Experiment', 
     #                                  backref=db.backref('lab'))
        }

Lab = ClassPersistenceTemplate.mk_persistent(Lab, ['lab_id'], **args)
...
class TestPersistentLab(TestCase):
    ...
    def test_create_lab(self):
        ...
        self.assertEqual(lab1.get("lab_name"), lab_name)
        self.assertEqual(lab1.get("lab_id"), lab_id)
