...
#+begin_src python
    ...
    def add_lab(data_dict):
        ...
        integration_status = System.do("get_integration_status", integration_level=integration_level)
        ...
        hosting_info = data_dict['hosting_info']
        hosting_info_list = []
        for hosting_info in hosting_info:
            hosting_info = System.do("get_hosting_info", hosted_url=hosting_info)
...
class TestAddLab(TestCase):
    ...
    def test_add_lab_in_system_interface(self):
        ...
        data_dict = {
                    ...
                    'hosting_info': ['http://cse14-iiith.vlabs.ac.in'],
                    'inst_id': 'IITK',
                    'dis_id': 'CSE',
...
class TestGetLabsByLabName(TestCase):
    ...
    def test_get_labs_in_system_interface(self):
        ...
        data_dict1 = {'lab_name': "data Automata",
                      'lab_id': 'DFA',
                      'key': KEY,
                      'overview': 'overview',
                      'inst_id': 'IITK',
...
class TestGetLabsByAsset(TestCase):
    ...
    def test_get_labs_by_asset_in_system_interface(self):
        ...
        labs = SystemInterface.get_labs_by_asset("vlabs.ac.in/images/static/logo.png")
...
#+begin_src python
    ...
    def get_hosting_info():
        ...
        try:
            ...
            current_app.logger.debug("got hosting_info")
...
#+begin_src python
    ...
    def get_integration_status_by_IL(integration_level):
        try:
            current_app.logger.debug("running operation get_integration_status_by_integration_level")
            integration_status_id = System.do("get_integration_status_by_IL", 
                                      integration_level=int(integration_level))
            current_app.logger.debug("completed operation get_integration_status_by_integration_level")
            return integration_status_id
...
#+NAME: class_get_assets_by_asset_type
#+begin_src python
    @staticmethod
    def get_assets_by_asset_type(asset_type):

        try:
            current_app.logger.debug("running operation get_assets_by_asset_type")
            assets = System.do("get_assets_by_asset_type", asset_type=str(asset_type))
            current_app.logger.debug("completed operation get_assets_by_asset_type")
            labs_dict_list = []
            for asset in assets:
                asset_x = asset.to_client()
                assets_dict_list.append(asset_x)
            current_app.logger.debug("got assets")
...
*** TestGetAssetsByAssetType

 #+NAME: test_class_get_assets_by_asset_type
 #+BEGIN_SRC python
class TestGetAssetsByAssetType(TestCase):
    TESTING = True
    def create_app(self):
        app = create_app(config)
        return app
    ...
    def test_get_assets_by_asset_type_in_system_interface(self):
        print "test_get_labs_by_asset_type_in_system_interface"
        ...
        assets = SystemInterface.get_assets_by_asset_type("Image")
...
#<<class_get_assets_by_asset_type>>
...
#<<test_class_get_assets_by_asset_type>>
<<run_test_cases>>
