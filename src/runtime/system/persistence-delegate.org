...
#+BEGIN_SRC python
   # def discipline_exists(self, discipline):
    #    dis_id = discipline.get("dis_id")
     #   return discipline == self.get_discipline(dis_id=dis_id)
...
def test_discipline_exists(self):
        ...
        dis_name1="IIT Delhi"
        dis_id1="EEE08"
        dis = Discipline(dis_name=dis_name1, dis_id=dis_id1, discipline=[])

        dis1 = self.persistence_delegate.add_discipline(dis)

        dis_name2="IIT Delhi"
        dis_id2="EEE09"
        dis2 = Discipline(dis_name=dis_name2, dis_id=dis_id2, discipline=[])

        self.assertEqual(self.persistence_delegate.lab_exists(dis1.id),
                            True)
